...
type Options struct {
	...
	Exec struct {
		...
		RunMutantID string `long:"run-mutant-id" description:"Run only the mutant with this stable ID. Copy the id field from go-mutesting-agentic.json to target a specific survivor."`
