...
- Build CLI: `go build ./cmd/go-mutesting`; whole tree: `go build ./...`.
- Test all packages: `go test ./...`; afterward restore integration fixture with `git restore example/example.go`.
- Run CLI smoke test: `go build -o /tmp/go-mutesting ./cmd/go-mutesting` then `/tmp/go-mutesting <real-package>`.
