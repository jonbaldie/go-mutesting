...
The skills speak in terms of two canonical category roles and five canonical state roles. This file maps those roles to the actual label strings used in `jonbaldie/go-mutesting`'s GitHub issue tracker.
